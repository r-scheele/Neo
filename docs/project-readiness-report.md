...
3. Prepare B06 next after approving its role/audit contract for server-side permissions and audit logs; do not run B07-B08 until required auth/secrets/contracts are ready.
